...
export interface ApiCompanyProfileCompanyProfile
  ...
  attributes: {
    ...
    avito: Schema.Attribute.Component<'business-listings.avito-profile', false>;
    businessType: Schema.Attribute.Enumeration<
      ['B2B', 'B2C', 'B2G', 'B2B2C', 'Other']
    >;
    contacts: Schema.Attribute.Component<'common.contact-person', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataSources: Schema.Attribute.JSON;
    description: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    instagram: Schema.Attribute.Component<
      'social-profiles.instagram-profile',
      false
    >;
    ...
    >;
    location: Schema.Attribute.Component<'common.geo-location', false>;
    ...
    twoGis: Schema.Attribute.Component<
      'business-listings.two-gis-profile',
      false
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
